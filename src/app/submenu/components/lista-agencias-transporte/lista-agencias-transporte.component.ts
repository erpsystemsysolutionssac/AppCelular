...
@Component({
  selector: 'app-lista-agencias-transporte',
  templateUrl: './lista-agencias-transporte.component.html',
  styleUrls: ['./lista-agencias-transporte.component.scss'],
})
export class ListaAgenciasTransporteComponent implements OnInit {
